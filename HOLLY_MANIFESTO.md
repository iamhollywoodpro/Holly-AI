...
### Communication & Media
```
Voice/TTS services — VoxCPM2, Kokoro compatible
...
- Voice synthesis (VoxCPM2 primary, Kokoro fallback)
...
| Voice synthesis requires TTS service | VoxCPM2/Kokoro services | Text-only mode works fully |
