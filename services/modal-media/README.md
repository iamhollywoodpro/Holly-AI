...
> ⚠️ **STOP: Check `holly-maya1-tts` first!**
> Your Modal dashboard shows `holly-maya1-tts` is **Live** on an A10G GPU.
> This app is **NOT being used by Holly** (Kokoro TTS replaced it).
> **It is burning your $30/mo free credits just by being deployed.**
> → Go to https://modal.com/apps/iamhollywoodpro/main and **stop/delete it**.
...
## Step 1: Stop the dead Maya1 TTS app (burning credits now)

```bash
pip install modal
modal app stop holly-maya1-tts
```

Or click **Stop** on https://modal.com/apps/iamhollywoodpro/main

---

## Step 2: Create HuggingFace secret on Modal
