...
## 🆚 Why Kokoro instead of Maya1?

| | Maya1 (old) | Kokoro (new) |
|---|---|---|
| Cost | Modal A10G GPU at $1.10/hr | **$0/month** |
| Cold start | 30–90 seconds | **Zero** (Docker stays warm) |
| Keep-alive ping | Every 4 min = $792/mo 24/7 | **Not needed** |
| CPU mode | No | **Yes** |
...
- [Chatterbox Turbo (fallback)](https://github.com/resemble-ai/chatterbox)
