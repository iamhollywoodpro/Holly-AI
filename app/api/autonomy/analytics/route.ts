...
async function calculateMetrics(since: Date) {
  ...
  if (total === 0) {
    return { total: 0, autoApproved: 0, successful: 0, failed: 0, autoApprovalRate: null, successRate: null, failureRate: null, byRiskLevel: { low: 0, medium: 0, high: 0 } };
  }
  ...
  return {
    ...
    successful,
    failed,
    autoApprovalRate: autoApproved / total,
