 ...
 *
 * Provider waterfall (HF_INFERENCE_ENABLED=false default → Modal only):
 *   DEFAULT: Modal.com MiniMax H3 (image-anchored I2V)
 *   OPT-IN:  HF CogVideoX-5B → HF Wan2.2-TI2V-5B → HF AnimateDiff (GIF)
...
export async function GET() {
  return NextResponse.json({
    ...
    providers: [
      { name: 'Cloudflare Workers AI', keyRequired: false, licence: 'Apache-2.0', note: 'Image lane only (free 10k neurons/day).' },
    ...
    models:  ['zeroscope-v2-xl', 'animatediff-v1.5'],
    cost:    0,
