...
function AuthPanel() {
  return (
    <div className="w-full space-y-3">
      ...
      <Link
        href="/sign-up"
        className="flex items-center justify-center gap-2 w-full py-3.5 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white rounded-xl font-semibold text-sm transition-all shadow-lg shadow-purple-500/20 active:scale-95"
      >
        ✦ Create Your Account
      </Link>
      ...
      <Link
        href="/sign-in"
        className="flex items-center justify-center gap-2 w-full py-3.5 bg-gray-800/70 hover:bg-gray-800 border border-gray-700/60 hover:border-purple-500/40 text-gray-300 hover:text-white rounded-xl font-medium text-sm transition-all active:scale-95"
      >
        Sign In
      </Link>
      ...
      <Link
        ...
        className="flex items-center justify-center gap-2.5 w-full py-3 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white rounded-xl font-medium text-sm transition-all active:scale-95"
      >
        ...
        >
          ...
          <div className="px-5 sm:px-8 pb-6 sm:pb-8 overflow-y-auto flex-1 space-y-5 sm:space-y-6">
            ...
            <div className="flex gap-3 pt-2">
              <Link
                href="/sign-up"
                className="flex-1 py-3.5 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white rounded-xl font-semibold text-sm transition-all shadow-lg shadow-purple-500/20 text-center"
              >
                ✦ Start With HOLLY
              </Link>
              <button
        ...
        >
          ...
          <div className="px-5 sm:px-8 pb-6 sm:pb-8 overflow-y-auto flex-1 space-y-4 sm:space-y-6">
            ...
            <div className="flex gap-3 pt-1">
              <Link href="/sign-up" className="flex-1 py-3.5 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 text-white rounded-xl font-semibold text-sm transition-all shadow-lg shadow-purple-500/20 text-center">
                ✦ Start With HOLLY
              </Link>
  ...
  return (
    ...
    <div className="min-h-screen bg-[#050508] text-white overflow-x-hidden overflow-y-auto">
      ...
      <nav className="relative z-20 flex items-center justify-between px-4 sm:px-6 md:px-12 py-4 sm:py-5 border-b border-white/5">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <Link href="/sign-in" className="text-xs sm:text-sm text-gray-400 hover:text-white transition-colors px-2 sm:px-4 py-2">Sign In</Link>
          <Link href="/sign-up" className="text-xs sm:text-sm bg-purple-600 hover:bg-purple-500 text-white px-4 sm:px-5 py-2 rounded-xl transition-all shadow-lg shadow-purple-500/20 font-medium">Get Started</Link>
        </div>
      </nav>
