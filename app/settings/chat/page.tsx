...
export default function ChatPreferencesPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Voice Settings */}
      <div className="space-y-6">
        <h3 className="text-[10px] font-black text-[#D4A853] uppercase tracking-[0.2em]">Neural Synchronization</h3>
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative inline-flex h-5 w-10 items-center rounded-full transition-colors duration-500 ${
              settings.chat.autoSpeak ? 'bg-[#D4A853]' : 'bg-white/10'
            }`}
          >
            <span
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-5 py-3 bg-[#1A1815] border border-white/5 rounded-2xl text-[#F5F0E8] text-[11px] font-black uppercase tracking-widest focus:outline-none focus:border-[#D4A853]/40 transition-all appearance-none cursor-pointer"
          >
      ...
      <div className="space-y-6 pt-10 border-t border-white/5">
        <h3 className="text-[10px] font-black text-[#D4A853] uppercase tracking-[0.2em]">Chronological Presentation</h3>
        ...
        <div>
          ...
          <div className="flex items-center gap-6">
            <input
              ...
              className="flex-1 h-1 bg-white/10 rounded-full appearance-none cursor-pointer accent-[#D4A853]"
            />
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative inline-flex h-5 w-10 items-center rounded-full transition-colors duration-500 ${
              settings.chat.showTimestamps ? 'bg-[#D4A853]' : 'bg-white/10'
            }`}
          >
            <span
              className={`inline-block h-3 w-3 transform rounded-full bg-[#F5F0E8] transition-transform duration-500 ${
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative inline-flex h-5 w-10 items-center rounded-full transition-colors duration-500 ${
              settings.chat.enterToSend ? 'bg-[#D4A853]' : 'bg-white/10'
            }`}
          >
            <span
              className={`inline-block h-3 w-3 transform rounded-full bg-[#F5F0E8] transition-transform duration-500 ${
      ...
      {/* Code Display */}
      <div className="space-y-6 pt-10 border-t border-white/5">
        <h3 className="text-[10px] font-black text-[#D4A853] uppercase tracking-[0.2em]">Architectural Presentation</h3>
      ...
      {/* Save indicator */}
      {isSaving && (
        <div className="text-[10px] text-[#D4A853] font-black uppercase tracking-widest flex items-center gap-3 pt-6">
