...
export default function AIBehaviorPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <label className="block text-[10px] font-black text-[#66CCCC] uppercase tracking-[0.2em] mb-4">SENTIENT PERSONA</label>
          ...
          {(['professional', 'casual', 'technical'] as const).map((style) => (
            ...
            >
              <div className="text-center">
                ...
                <div className={`text-[10px] font-black uppercase tracking-widest ${settings.ai.responseStyle === style ? 'text-[#66CCCC]' : 'text-[#F5F0E8]'}`}>
      ...
      {/* Context Window */}
      <div>
        <label className="block text-[10px] font-black text-[#66CCCC] uppercase tracking-[0.2em] mb-4">
          NEURAL BUFFER DEPTH
        </label>
        <div className="flex items-center gap-6">
          <input
            ...
            className="flex-1 h-1.5 bg-white/5 rounded-full appearance-none cursor-pointer accent-[#66CCCC]"
          />
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative inline-flex h-5 w-10 items-center rounded-full transition-colors duration-500 ${
              settings.ai.autoSave ? 'bg-[#66CCCC]' : 'bg-white/10'
            }`}
          >
            <span
      ...
      <div className="bg-[#66CCCC]/5 border border-[#66CCCC]/20 rounded-2xl p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <div className="text-[10px] font-black text-[#66CCCC] uppercase tracking-[0.2em] mb-2">Neural Heuristics</div>
