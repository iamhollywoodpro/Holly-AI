      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '2rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1rem' }}>
            <Brain size={32} color={cyberpunkTheme.colors.primary} />
        ...
        <div style={{
          ...
          <Search size={20} color={cyberpunkTheme.colors.textSecondary} />
          <input
            type="text"
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
              <Clock size={20} color={cyberpunkTheme.colors.accent} />
            ...
            <div style={{
              ...
              <Clock size={48} color={cyberpunkTheme.colors.border} style={{ margin: '0 auto 1rem' }} />
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
              <Tag size={20} color={cyberpunkTheme.colors.secondary} />
            ...
            <div style={{
              ...
              <Tag size={48} color={cyberpunkTheme.colors.border} style={{ margin: '0 auto 1rem' }} />
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1rem' }}>
              <Brain size={20} color={cyberpunkTheme.colors.primary} />
            ...
            <div style={{
              ...
              <Brain size={48} color={cyberpunkTheme.colors.border} style={{ margin: '0 auto 1rem' }} />
        ...
        <div style={{
          marginTop: '2rem',
          background: `${cyberpunkTheme.colors.primary}15`,
          border: `1px solid ${cyberpunkTheme.colors.primary}40`,
          borderRadius: '12px',
          padding: '1.5rem',
        }}>
          <h4 style={{ margin: '0 0 0.5rem 0', color: cyberpunkTheme.colors.primary }}>
