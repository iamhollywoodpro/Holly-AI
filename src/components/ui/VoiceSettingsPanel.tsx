            ...
            <div className="space-y-6">
              ...
              <div className="mt-6 p-4 rounded-lg bg-purple-500/10 border border-purple-500/20">
                <p className="text-xs text-gray-400">
                  <span className="font-medium text-purple-400">VoxCPM2 TTS</span> (primary)
                  <br />
                  Expressive character voice with emotion tags.
                  <br />
                  <span className="text-gray-500">Fallback: Kokoro-FastAPI (ultra-low latency)</span>
                </p>
              </div>
            </div>
          </motion.div>
