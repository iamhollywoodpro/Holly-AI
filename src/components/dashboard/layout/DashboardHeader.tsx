      ...
      <div className="flex flex-1 items-center gap-4">
        <div className="relative w-96">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="w-full rounded-lg border border-[#66CCCC]/15 bg-[#1E1B18] py-2 pl-10 pr-4 text-sm text-[#F5F0E8] placeholder-[#5C564D] focus:border-[#66CCCC]/40 focus:outline-none focus:ring-1 focus:ring-[#66CCCC]/30"
          />
        </div>
      </div>
