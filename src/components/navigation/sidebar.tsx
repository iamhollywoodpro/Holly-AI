...
const navItems: NavItem[] = [
  ...
  { id: 'builder', label: 'AI Builder', icon: Hammer, href: '/builder', badge: 'NEW' },
  { id: 'music-studio', label: 'Music Studio', icon: Music, href: '/music-studio' },
  { id: 'image', label: 'Generation Studio', icon: ImageIcon, href: '/generate/studio' },
  { id: 'video', label: 'Video Studio', icon: Video, href: '/generate/video' },
  { id: 'audio', label: 'Audio Studio', icon: Mic, href: '/generate/music' },
  { id: 'files', label: 'Files', icon: FolderOpen, href: '/files' },
  { id: 'evolution', label: 'Evolution', icon: TrendingUp, href: '/evolution' },
  { id: 'autonomy', label: 'Autonomy', icon: Activity, href: '/autonomy' },
