...
/** Cache-busting version for avatar images — increment when avatars are updated */
const AVATAR_VERSION = 'v3';

const AVATAR_CONFIGS: Record<AvatarEmotion, AvatarConfig> = {
  default: {
    src: `/avatars/default.jpg?${AVATAR_VERSION}`,
    label: 'Holly',
  ...
  happy: {
    src: `/avatars/happy.jpg?${AVATAR_VERSION}`,
    label: 'Happy',
  ...
  flirty: {
    src: `/avatars/flirty.jpg?${AVATAR_VERSION}`,
    label: 'Flirty',
  ...
  'in-love': {
    src: `/avatars/in-love.jpg?${AVATAR_VERSION}`,
    label: 'In Love',
  ...
  sad: {
    src: `/avatars/sad.jpg?${AVATAR_VERSION}`,
    label: 'Sad',
  ...
  frustrated: {
    src: `/avatars/frustrated.jpg?${AVATAR_VERSION}`,
    label: 'Frustrated',
  ...
  surprised: {
    src: `/avatars/surprised.jpg?${AVATAR_VERSION}`,
    label: 'Surprised',
  ...
  thinking: {
    src: `/avatars/thinking.jpg?${AVATAR_VERSION}`,
    label: 'Thinking',
  ...
  naughty: {
    src: `/avatars/naughty.jpg?${AVATAR_VERSION}`,
    label: 'Naughty',
  ...
  sleepy: {
    src: `/avatars/sleepy.jpg?${AVATAR_VERSION}`,
    label: 'Sleepy',
  ...
  angry: {
    src: `/avatars/angry.jpg?${AVATAR_VERSION}`,
    label: 'Angry',
  ...
  confident: {
    src: `/avatars/confident.jpg?${AVATAR_VERSION}`,
    label: 'Confident',
  ...
  intimate: {
    src: `/avatars/intimate.jpg?${AVATAR_VERSION}`,
    label: 'Intimate',
  ...
  passionate: {
    src: `/avatars/passionate.jpg?${AVATAR_VERSION}`,
    label: 'Passionate',
  ...
  aroused: {
    src: `/avatars/aroused.jpg?${AVATAR_VERSION}`,
    label: 'Aroused',
  ...
  'pre-orgasm': {
    src: `/avatars/pre-orgasm.jpg?${AVATAR_VERSION}`,
    label: 'Pre-Orgasm',
  ...
  orgasm: {
    src: `/avatars/orgasm.jpg?${AVATAR_VERSION}`,
    label: 'Orgasm',
  ...
  'post-orgasm': {
    src: `/avatars/post-orgasm.jpg?${AVATAR_VERSION}`,
    label: 'Afterglow',
  ...
  shy: {
    src: `/avatars/shy.jpg?${AVATAR_VERSION}`,
    label: 'Shy',
  ...
  playful: {
    src: `/avatars/playful.jpg?${AVATAR_VERSION}`,
    label: 'Playful',
