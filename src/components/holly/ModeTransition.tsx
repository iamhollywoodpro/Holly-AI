...
export const MODE_CONFIGS: Record<string, ModeConfig> = {
  default: {
    ...
    color: 'text-holly-teal', bg: 'bg-holly-teal/10', border: 'border-holly-teal/30',
    gradient: 'from-holly-teal/20 to-holly-void',
  },
  'deep-research': {
    id: 'deep-research', label: 'Research', icon: Search,
    color: 'text-holly-teal/90', bg: 'bg-holly-teal/10', border: 'border-holly-teal/30',
    gradient: 'from-holly-teal/20 to-holly-void',
  },
  'music-generation': {
  ...
  'aura-ar': {
    ...
    color: 'text-holly-coral', bg: 'bg-holly-coral/10', border: 'border-holly-coral/30',
    gradient: 'from-holly-coral/20 to-holly-void',
  },
  'creative-writing': {
  ...
  philosophy: {
    ...
    color: 'text-holly-teal/80', bg: 'bg-holly-teal/5', border: 'border-holly-teal/20',
    gradient: 'from-holly-teal/10 to-holly-void',
  },
