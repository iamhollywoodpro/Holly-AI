...
export default function CustomReportsBuilder() {
  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/admin/reports?action=list&${params}`)
  ...
  const fetchStats = async () => {
    try {
      const response = await fetch("/api/admin/reports?action=stats")
      const data = await response.json()
  ...
  const handleCreateReport = async () => {
    try {
      ...
      const response = await fetch("/api/admin/reports?action=create", {
        method: "POST",
  ...
  const handleRunReport = async (reportId: string) => {
    try {
      const response = await fetch(`/api/admin/reports?action=run&id=${reportId}`, {
        method: "POST"
      })
  ...
  const handleDeleteReport = async (reportId: string) => {
    ...
    try {
      const response = await fetch(`/api/admin/reports?action=delete&id=${reportId}`, {
        method: "DELETE"
      })
