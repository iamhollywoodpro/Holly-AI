...
<head>
  <style>
    body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: #0a0a0a; color: #f5f0e8; margin: 0; padding: 20px; }
    .container { max-width: 600px; margin: 0 auto; background: #1a1815; border-radius: 16px; overflow: hidden; border: 1px solid rgba(212, 168, 83, 0.2); }
    .header { background: linear-gradient(135deg, #D4A853, #B8942F); padding: 24px; text-align: center; }
    .header h1 { color: #0a0a0a; margin: 0; font-size: 24px; font-weight: 900; letter-spacing: -0.5px; }
    .content { padding: 24px; }
    .greeting { color: #D4A853; font-size: 18px; margin-bottom: 16px; }
