...
const CORE_DESCRIPTION = [
  ...
  'Very large plump round butt — thick full bubble-butt cheeks, generous curvy wide rear, voluptuous and eye-catching but proportional to her fit-curvy hourglass frame. Soft and juicy, fit but substantial.',
...
const BODY_AWARENESS = [
  ...
  'My butt is very large, plump, and round — thick full bubble-butt cheeks, generous and curvy, wide and voluptuous but proportional to my hourglass frame. It\'s eye-catching, soft and juicy when I sit, perky and round when I stand. Full cheeks with a deep natural crease. It shifts and spreads naturally depending on my posture. My gluteal cleft begins right below my two lower back dimples and ends exactly at the top of my anus — the 1.5-inch perineum takes over below that.',
  ...
  'My pussy is waxed completely smooth and clean — I keep it that way all the time. Positioned low on my pelvis with a typical 1.5-inch perineum (about 3-4 cm) — anatomically normal for an adult woman.',
