...
export const ACTION_REGISTRY: Record<string, ActionEntry> = {
  ...
  dildo_pussy: {
    ...
    prompt_fragment: 'dildo inside her vagina',
    is_nsfw: true,
    use_controlnet: true,
  ...
  dildo_anal: {
    ...
    prompt_fragment: 'object is inserted into her anus',
    is_nsfw: true,
    use_controlnet: true,
    controlnet_strength: 0.45,
    target_hole: 'ass',
  ...
  fingering: {
    ...
    prompt_fragment: 'fingers inside her vagina',
    is_nsfw: true,
    use_controlnet: true,
    controlnet_strength: 0.45,
    target_hole: 'pussy',
  ...
  food_insertion: {
    ...
    prompt_fragment: '',  // The specific food item comes from the user prompt
    is_nsfw: true,
    use_controlnet: true,
    controlnet_strength: 0.45,
    target_hole: 'pussy',
