...
const APPROVED_LICENCES = new Set([
  ...
  'Modified-MIT',       // Mistral Medium 3.5 (open for commercial use)
  'Gemma',              // Google Gemma 4 (open, permissive)
  'NVIDIA-Open-Model',  // NVIDIA Nemotron (commercial-use allowed)
  'DeepSeek',           // DeepSeek V4 (open, commercial-use)
]);
