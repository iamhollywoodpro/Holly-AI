 ...
 * Voice OUTPUT: EnhancedVoiceOutput → VoxCPM2 (primary) → Kokoro (fallback)
 *
...
// NOTE: isSpeechSynthesisAvailable removed — HOLLY uses Kokoro/VoxCPM2 TTS,
...
// Use EnhancedVoiceOutput directly — it routes to Kokoro → VoxCPM2.
