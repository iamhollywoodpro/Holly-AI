...
const codebase_parser_1 = require("../src/lib/metamorphosis/codebase-parser");
const architecture_mapper_1 = require("../src/lib/metamorphosis/architecture-mapper");
const dependency_graph_1 = require("../src/lib/metamorphosis/dependency-graph");
...
async function generateArchitecture() {
    ...
    try {
        ...
        const mapper = new architecture_mapper_1.ArchitectureMapper(projectRoot);
        ...
        const graphGenerator = new dependency_graph_1.DependencyGraphGenerator(projectRoot);
        ...
        const parser = new codebase_parser_1.CodebaseParser(projectRoot);
