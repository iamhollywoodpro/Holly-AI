...
**What is missing:**  
HOLLY has TTS (Kokoro + VoxCPM2) and a transcribe endpoint, but there is **no voice conversation loop** — the ability to speak to HOLLY and hear her speak back, end-to-end, in a continuous voice session.
