...
HOLLY 2.2 added Phase 9 architecture foundations: multimodal perception, audio analysis engine, semantic memory scaffolding, self-code awareness system, voice synthesis (Kokoro + VoxCPM2), expanded LLM provider routing, and the autonomous background learning cron system.
...
- **VoxCPM2 TTS:** Alternative voice
- `/api/voice/` — 5 endpoints (batch, command, stream, synthesize, transcribe)
...
| **Voice Synthesis** | Kokoro TTS, VoxCPM2 TTS |
