...
-- AddForeignKey
ALTER TABLE "music_analyses" ADD CONSTRAINT "music_analyses_trackId_fkey" FOREIGN KEY ("trackId") REFERENCES "music_tracks"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "music_analyses" ADD CONSTRAINT "music_analyses_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
